...
const Page = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <ImageBackground
        source={require("../images/signin-top.jpg")}
        style={styles.imageBackground}
      >
        <Text style={styles.greetingText}>Hello There,</Text>
        <Text style={styles.gladText}>Welcome Back..</Text>
      </ImageBackground>
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.signinText}>
          <Text style={styles.signinText1}>Create a new Account?</Text>
          <Text style={styles.signinText2} onPress={handleSignup}>Signup</Text>
        </View>
      </View>
